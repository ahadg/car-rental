        ...
        <Grid className={styles.container} item xs>
            <Typography className={styles.title} variant="h5" component="h3">
                ...
                <div className={styles.time}>
                    <div onClick={() =>  setztime('AM')} className={ztime == "AM" ? styles.timeblockactive : styles.timeblock}>AM</div>
                    <div onClick={()=> setztime('PM')} className={ztime == "PM" ? styles.timeblockactive : styles.timeblock}>PM</div>
                </div>
            </Typography>
